            ...
            <h1>Cadastra-se</h1>
             ...
             <div class="texto">
                ...
                <div class="form-group">
                  ...
                  <a href="inicio.php"><button type="button" class="btn btn-warning" style="margin-left: 600px;margin-top: -65px;">Cadastrar</button></a>
             </div>
             <img src="img00.png" class="imgcadastro" alt="img">
        </form>
        </fieldset>
        </center>
    </main>
